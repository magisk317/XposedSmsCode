...
- Renovate: GitLab has a scheduled pipeline using `.gitlab/renovate-config.js` and the hidden `RENOVATE_TOKEN` variable; manual web/API pipelines need `DEPENDENCY_OWNER=gitlab` to run only Renovate.
