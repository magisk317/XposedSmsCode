...
/**
 * Miuix chrome for the SMS code rule list. Wraps the kit page scaffold with
 * the F7 quick return-to-top affordances: a transparent double-tap hotspot
 * over the top bar title strip (clear of the back arrow and the actions)
 * plus a scroll-to-top FAB lifted above the page's own add FAB.
 */
@Composable
